...
public class ScrollRectAutoScroll : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void InputScroll()
    {
        ...
        {
            if (InputManager.GetAxisDir(0, InputAxis.Left, InputAxisDir.N) || InputManager.GetAxisDir(0, InputAxis.Left, InputAxisDir.S) || InputManager.GetButtons(0, InputButton.Up, InputButton.Down))
            {
